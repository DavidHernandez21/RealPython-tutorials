...
class Message:
    ...
    def process_request(self):
        ...
        if self.jsonheader["content-type"] == "text/json":
            ...
            self.request = encoding_decoding.json_decode(data, encoding)
        ...
        events = event_selector.set_selector_events_mask(mode="w")
        self.selector.modify(self.sock, events, data=self)
    ...
    def create_response(self):
        ...
        message = create_message.new_message(**response)
